...
async function searching(departure, arrival, startDate, endDate) {
    try {
        const response = await fetch(`https://traveling-booking-website.onrender.com/tours?departure_location=${departure}&arrival_location=${arrival}&start_date=${startDate}&end_date=${endDate}`);
        if (!response.ok) {
...
async function fetchFeaturedTours() {
    try {
        const response = await fetch(`https://traveling-booking-website.onrender.com/featured_tours`);
        if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
        }
...
async function fetchTours() {
    try {
        const response = await fetch(`https://traveling-booking-website.onrender.com/tours`);
        if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
        }
